...
const Products = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            await dispatch(fetchProducts({pageNumber, pageSize, searchKeyword, sortBy, selectedCategories, minPrice, maxPrice }))
        }
        fetchData()
    ...
    return(
        ...
        <div className="sidebar">
            <div>
                ...
                {categories && categories.length > 0 && categories.map((category) => <div key={category.categoryId}>
